...
Open `hackathon.ipynb` directly in <a href="https://colab.research.google.com/github/Universidata-srl/hackathon/blob/main/hackathon.ipynb" target="blank">Google Colab</a>, or:
