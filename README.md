...
All the instructions are in `hackathon.ipynb` $-$ open it directly in <a href="https://colab.research.google.com/github/Universidata-srl/hackathon/blob/main/hackathon.ipynb" target=_blank style="display: inline">Google Colab</a>, or:
